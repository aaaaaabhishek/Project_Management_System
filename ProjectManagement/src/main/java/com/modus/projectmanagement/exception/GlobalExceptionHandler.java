...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ManagerExistException.class)
    public ResponseEntity<String> handleManagerExistException(ManagerExistException managerExistException) {
        logger.error("Manager is already present with this manager_id: {}", managerExistException.getMessage(), managerExistException);
return new ResponseEntity<>(managerExistException.getMessage(),HttpStatus.BAD_REQUEST);
    }
    @ExceptionHandler(InvalidDateFormatException.class)
    public ResponseEntity<String> handleInvalidDateFormatException(InvalidDateFormatException invalidDateFormatException) {
        logger.error("Invalid date format exception: {}", invalidDateFormatException.getMessage(), invalidDateFormatException);
        return new ResponseEntity<>(invalidDateFormatException.getMessage(),HttpStatus.BAD_REQUEST);
    }
