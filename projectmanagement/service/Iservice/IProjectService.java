...
import com.modus.projectmanagement.exception.ProjectIdNotFoundException;
...
public class IProjectService implements ProjectService {
    ...
    public ProjectDto createProject(ProjectDto projectDto) {
        Manager manager = managerRepository.findById(Long.valueOf(projectDto.getManagerId()))
    ...
    public ProjectDto getProjectById(String projectId) {
      Project project=projectRepository.findById(projectId)
                .orElseThrow(()->new ProjectIdNotFoundException("Project with this projetId"+projectId+" not found"));
